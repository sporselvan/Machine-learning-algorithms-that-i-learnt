...
data %>%
  ...
  geom_density(alpha=0.8, color='black') +   ##plot shows some overlapping between admit and  gpa
  ggtitle('Density Plot') 
...
# Using laplace correction  for improving model
model1<-naive_bayes(admit~.,test,laplace=2)
